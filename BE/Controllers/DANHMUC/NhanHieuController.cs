...
namespace BE.Controllers.DANHMUC
{
    ...
    [ApiController]
    public class NhanHieuController : BaseController<NhanHieuController>
    {
        private readonly INHANHIEUService _service;
        public NhanHieuController(INHANHIEUService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public IActionResult Create(NhanHieuRequests request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        [HttpPost]
        public IActionResult Update(NhanHieuRequests request)
        {
            try
            {
                if (!ModelState.IsValid)
