...
namespace BE.Helper
{
    ...
    {
        public static IEnumerable<TModel> ExcuteStoredProcedure<TModel>(this EShoppingContext _context ,string nameofStored, SqlParameter[]? parameters) where TModel : new()
        {
